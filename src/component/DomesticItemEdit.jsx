...
class DomesticItemEdit extends Component {
 ...
 constructor(props) {
        ...
        this.loadRicefwItem = this.loadRicefwItem.bind(this)
        this.onSubmit = this.onSubmit.bind(this)
    }

    componentDidMount() {
        RicefwService.getRicefwItem(this.props.params.ricefwId)
        .then(response => this.loadRicefwItem(response))
    }

    loadRicefwItem(response) {
        this.setState({
            ricefwItem: response.data
        })

        console.log(this.state.ricefwItem)
    }
    ...
    onSubmit(values) {
        ...
        RicefwService.updateRicefwItem(this.props.params.ricefwId, ricefwItem)
                            ...
                            (props) => (
                                <Form className="row g-3">
                                    ...
                                    <fieldset className="col-md-4 input-spacing">
                                        ...
                                        <Field type="text" className="form-control" name="ricefwItem.processAreaText" disabled/>
                                    </fieldset>
                                    <fieldset className="col-md-4 input-spacing">
                                        <label className="form-label">Object Type</label>
                                        <Field type="text" className="form-control" name="ricefwItem.objectType" disabled/>
                                    </fieldset>
                                    <fieldset className="col-md-4 input-spacing">
                                        <label className="form-label">Object Type Text</label>
                                        <Field type="text" className="form-control" name="ricefwItem.objectTypeText" disabled/>
                                    </fieldset>
                                    <fieldset className="col-md-4 input-spacing">
                                        <label className="form-label">Region</label>
                                        <Field type="text" className="form-control" name="ricefwItem.region" disabled/>
                                    </fieldset>
                                    <fieldset className="col-md-4 input-spacing">
...
export default DomesticItemEdit